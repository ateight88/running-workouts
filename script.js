...
const workouts = [
  {
    id: 'jakob-am-threshold', category: 'threshold', tag: 'Threshold', difficulty: 'Hard',
    athlete: 'Jakob Ingebrigtsen',
    title: '5 × 6 min Threshold',
    description: 'The morning half of the Ingebrigtsen-style double-threshold day: long, controlled repetitions with short recovery.',
    preview: '5 × 6 min · 2 min recovery',
    warmup: 'About 30 min easy running before the first interval.',
    main: ({ threshold }) => `5 × 6 min at controlled threshold effort, around ${threshold}, with 2 min easy recovery between repetitions.`,
    cooldown: 'About 10 min easy running.',
    source: 'Göran Winblad — Ingebrigtsen Training Calculator'
  },
  {
    id: 'jakob-pm-threshold', category: 'threshold', tag: 'Threshold', difficulty: 'Very hard',
    athlete: 'Jakob Ingebrigtsen',
    title: '8 × 1 km Threshold',
    description: 'The shorter, slightly quicker evening session from the double-threshold day. The key is control rather than racing the repetitions.',
    preview: '8 × 1 km · 1 min recovery',
    warmup: 'About 15 min easy running.',
    main: ({ threshold }) => `8 × 1 km around ${threshold} with 1 min easy recovery between repetitions. Keep the pace repeatable from the first rep to the last.`,
    cooldown: 'About 15 min easy running.',
    source: 'Göran Winblad — Ingebrigtsen Training Calculator'
  },
  {
    id: 'kipchoge-15x1k', category: 'vo2', tag: 'Intervals', difficulty: 'Very hard',
    athlete: 'Eliud Kipchoge',
    title: '15 × 1 km',
    description: 'A classic Kipchoge track session built around a large volume of fast kilometre repetitions.',
    preview: '15 × 1 km · 2 min jog',
    warmup: '3 km easy running before the session.',
    main: ({ interval }) => `15 × 1 km around ${interval} with 2 min easy jogging recovery. Scale the number of repetitions down if this volume is beyond your normal training load.`,
    cooldown: '3 km easy running.',
    source: 'Eliud Kipchoge training documented and adapted by Göran Winblad'
  },
  {
    id: 'kipchoge-fast-float', category: 'threshold', tag: 'Fast / Float', difficulty: 'Very hard',
    athlete: 'Eliud Kipchoge',
    title: '12 × (1 km Fast + 1 km Float)',
    description: 'A continuous alternating session: a fast kilometre followed by a controlled float kilometre, repeated without standing recovery.',
    preview: '12 × 1 km fast / 1 km float',
    warmup: '3 km easy running.',
    main: ({ interval, steady }) => `12 rounds of 1 km fast around ${interval}, then 1 km float around ${steady}. The float is active running, not a recovery stop.`,
    cooldown: '3 km easy running.',
    source: 'Eliud Kipchoge training documented and adapted by Göran Winblad'
  },
  {
    id: 'kipchoge-5x3k', category: 'threshold', tag: 'Long Intervals', difficulty: 'Very hard',
    athlete: 'Eliud Kipchoge',
    title: '5 × 3 km',
    description: 'Long sustained repetitions separated by a kilometre of easier running. This is a major endurance workout even for experienced runners.',
    preview: '5 × 3 km hard · 1 km easy',
    warmup: '3 km easy running.',
    main: ({ threshold, easy }) => `5 × 3 km around ${threshold}, with 1 km easy running around ${easy} between repetitions. Consider 3–4 reps if you are not accustomed to this workload.`,
    cooldown: '3 km easy running.',
    source: 'Eliud Kipchoge training documented and adapted by Göran Winblad'
  },
  {
    id: 'kipchoge-ladder', category: 'speed', tag: 'Ladder', difficulty: 'Very hard',
    athlete: 'Eliud Kipchoge',
    title: '5K–3K–2K–1K + 4 × 200 m',
    description: 'A descending-distance track session that moves from sustained work toward faster running at the end.',
    preview: '5K · 3K · 2K · 1K · 4 × 200 m',
    warmup: '3 km easy running.',
    main: ({ threshold, interval, repetition }) => `Run 5 km and 3 km around ${threshold}, then 2 km and 1 km progressing toward ${interval}. Recover 5, 3, 2 and 1 min respectively, then finish with 4 × 200 m around ${repetition} with 200 m easy jog.`,
    cooldown: '3 km easy running.',
    source: 'Eliud Kipchoge training documented and adapted by Göran Winblad'
  },
  {
    id: 'kilian-vk10k', category: 'aerobic', tag: 'Mountain Challenge', difficulty: 'Extreme',
    athlete: 'Kilian Jornet',
    title: 'VK + 10K Challenge',
    description: 'A famous mountain-to-road test: climb one vertical kilometre, descend, then run a flat 10K. This is a challenge rather than a routine weekly workout.',
    preview: '1,000 m vertical climb · descend · 10K',
    warmup: 'Warm up thoroughly before the climb, including easy running and uphill mobility.',
    main: ({ threshold }) => `Complete a route gaining 1,000 vertical metres, descend safely, then run 10 km at a strong sustainable effort. For a training version, aim around ${threshold} rather than attempting Jornet's all-out benchmark.`,
    cooldown: 'Walk or jog very easily and allow substantial recovery afterward.',
...
const goranWorkouts = [
  {
    ...
    "surface": "track",
    "recovery": "90 seconds after the opening 200m, 60 seconds after the 600m, and 4:30 between complete sets.",
    "appCategory": "speed"
  },
  {
    ...
    "category": "threshold",
    "surface": "treadmill",
    "recovery": "15 seconds standing or slow float recovery between every 45-second repetition. Ends immediately after final rep.",
  ...
  },
  {
    ...
    "category": "10k",
    "surface": "track",
    "recovery": "Strict 30 seconds standing or walking recovery between 400m repetitions.",
    "appCategory": "vo2"
  },
  {
    ...
    "category": "threshold",
    "surface": "treadmill",
    "recovery": "The app suggests two minutes easy between six-minute efforts; the source does not specify recovery.",
    "appCategory": "threshold"
  },
  {
    ...
    "recovery": "Jog back down after each hill. Take 3–5 minutes between sets; the app uses four minutes.",
    "appCategory": "speed"
  },
  {
  ...
  },
  {
    ...
    "category": "marathon",
    "surface": "track",
    "recovery": "100m walk + 100m jog between efforts. The displayed duration is approximate.",
    "appCategory": "threshold"
  },
  {
  ...
  },
  {
    ...
    "surface": "track",
    "recovery": "One easy lap jog between segments; 90s between 1K reps; 60s between 300m and 200m reps.",
    "appCategory": "speed"
  },
  {
    ...
    "purpose": "Develop sustained endurance within your established long-run range.",
    "category": "long_run",
    "surface": "rolling_hills",
    "recovery": "Continuous running. Plan fluid and fuel access around the route and conditions.",
    "appCategory": "aerobic"
  },
  {
  ...
  },
  {
    ...
    "subtitle": "Averaging 62.72s with 30s recovery and mid-session lactate pause",
    "purpose": "Practise steady turnover in two manageable blocks.",
    "category": "threshold",
    "surface": "track",
    "recovery": "App suggestions: 30 seconds between reps and two minutes between sets.",
    "appCategory": "threshold"
  },
  {
  ...
  },
  {
    ...
    "category": "3k_5k",
    "surface": "track",
    "recovery": "App suggestions: six minutes after the long opener, eight minutes after the middle rep, and one minute between 300s.",
    "appCategory": "vo2"
  },
  {
    ...
    "category": "3k_5k",
    "surface": "track",
    "recovery": "App suggestions: generous recovery between the bookends and middle block, and 90 seconds between 800m reps.",
    "appCategory": "vo2"
  },
  {
  ...
  },
  {
    ...
    "athlete": "Nick Willis",
    "title": "The Michigan",
    "subtitle": "Classic Warhurst session: track reps alternating with 2K road tempos",
    "purpose": "Alternate track speed with sustained tempo running.",
    "category": "mixed_speed",
    "surface": "track",
    "recovery": "The app suggests 400m easy jog transitions. Recovery distances and pace were not specified in the account.",
    "appCategory": "speed"
  },
  {
    ...
    "category": "mixed_speed",
    "surface": "track",
    "recovery": "Recoveries were not reported; the app proposes 3:00, 2:00 and 1:30 by section.",
    "appCategory": "speed"
  },
  {
  ...
  },
  {
    ...
    "category": "hills",
    "surface": "rolling_hills",
    "recovery": "Easy and downhill sections connect the circuit. The app also suggests three minutes easy between complete circuits.",
    "appCategory": "speed"
  },
  {
    ...
    "category": "mixed_speed",
    "surface": "track",
    "recovery": "Active recoveries were characteristic; 45 seconds is an app suggestion.",
    "appCategory": "speed"
  },
  {
  ...
  },
  {
    ...
    "category": "10k",
    "surface": "track",
    "recovery": "One minute between reps is reported. The app suggests 10K effort; it is not Waitz’s reported pace.",
    "appCategory": "vo2"
  },
  {
    ...
    "category": "3k_5k",
    "surface": "track",
    "recovery": "100m jogs (about 45s) and three minutes between sets are reported. Pace is an app estimate.",
    "appCategory": "vo2"
  },
  {
    ...
    "category": "long_run",
    "surface": "road",
    "recovery": "Continuous progression. App paces progress from easy to estimated marathon pace; none are historical splits.",
    "appCategory": "aerobic"
  },
  {
    ...
    "category": "hills",
    "surface": "rolling_hills",
    "recovery": "Walk back fully between efforts. Two minutes is an app suggestion; take longer if needed.",
    "appCategory": "speed"
  }
];
...
function paceKeyForSourceCategory(category) {
  ...
  if (category === 'mile_specific' || category === 'race_primer' || category === 'mixed_speed' || category === 'fartlek' || category === 'hills') return 'repetition';
  return 'steady';
}

workouts.push(...goranWorkouts.map(w => ({
  id: `goran-${w.id}`,
  category: w.appCategory,
  tag: w.category.replaceAll('_', ' ').replace(/\b\w/g, c => c.toUpperCase()),
  difficulty: ['long_run'].includes(w.category) ? 'Moderate' : ['threshold', 'marathon', '10k'].includes(w.category) ? 'Hard' : 'Very hard',
  athlete: w.athlete,
  title: w.title,
  description: w.purpose || `A ${w.surface.replaceAll('_', ' ')} session from the Train Like the Pros workout library.`,
  preview: w.subtitle,
  warmup: w.category === 'hills' ? '15–20 min easy running, then drills and a few short strides.' : '15–20 min easy running, then 3–4 relaxed strides before the first hard effort.',
  main: paces => {
    const key = paceKeyForSourceCategory(w.category);
    const target = paces[key];
    const paceNote = w.category === 'hills' ? 'Run the uphill efforts by strong, controlled effort rather than forcing a flat-road pace.' : `Use about ${target} as a scaled intensity guide where the session calls for sustained hard running.`;
    return `${w.title}: ${w.subtitle} ${w.recovery ? `Recovery: ${w.recovery}` : ''} ${paceNote}`;
  },
  cooldown: '10–20 min very easy running. Reduce the volume if this session is substantially larger than your normal workout load.',
  source: 'Workout structure from Göran Winblad’s Train Like the Pros app data.'
})));
...
function renderWorkouts() {
  ...
  workouts
    ...
    .forEach(workout => {
      ...
      node.querySelector('.athlete-name').textContent = `Inspired by ${workout.athlete}`;
